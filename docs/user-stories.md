...
***"As a counter clerk, i want to register the customers contact information, the bikes identifying information, the reported issues by the customer, a photo of the bike's initial state and a target return date promised to the customer before taking the bike in, so that the bike is fully identified, ready to be worked on and have a way to contact the owner of it"***
