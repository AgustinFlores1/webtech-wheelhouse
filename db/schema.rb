...
ActiveRecord::Schema[8.1].define(version: 2026_09_07_203613) do
  ...
  create_table "repair_services", force: :cascade do |t|
    ...
    t.index ["service_catalog_id"], name: "index_repair_services_on_service_catalog_id"
  end
  ...
  create_table "repairs", force: :cascade do |t|
    ...
    t.string "status", default: "arrived", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "service_catalogs", force: :cascade do |t|
    ...
    t.string "name", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_service_catalogs_on_name", unique: true
  end
